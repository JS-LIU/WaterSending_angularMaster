...
(function(){
    ...
    Login.prototype.getAccessInfo = function(cookie,isL){
        ...
        return accessInfo(cookie,isLogin,defineApp_key,defineApp_secret,defineApp_md5_app_secret);
    }
    function accessInfo(c,isL,app_key,app_secret,app_md5_app_secret){
        if(isL){
            var access_token = c.get('access_token').access_token;
            var access_token_secret = c.get('access_token').access_token_secret;
            return {
                app_key:app_key,

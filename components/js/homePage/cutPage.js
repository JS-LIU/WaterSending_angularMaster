...
$('.J_cutIcon a').click(function(){
    ...
    var picArr = [{showicon:'mainf-ds-c',hideicon:'mainf-ds-n'},{showicon:'mainf-dd-c',hideicon:'mainf-dd-n'},{showicon:'mainf-sp-c',hideicon:'mainf-sp-n'},{showicon:'mainf-wd-c',hideicon:'mainf-wd-n'}];

...
//(function(){
//    angular.module('WXpay',['ngRoute','ngCookies','ngResource','huipayLogin'])
//        .controller('orderModel',orderModel);
//    function orderModel($scope,$cookieStore,Login){
...
pay.controller('orderModel',function($scope,$cookieStore,payPost,log,getAccessInfo,queryOrderData){
    var order = $cookieStore.get('orderId');
    $scope.orderId = order["orderId"];
    $scope.payMoney = order["final_fee"];
    var host = window.location.host;
